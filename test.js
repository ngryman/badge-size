...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/changes/README.md.svg"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/changes/README.md.png"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/changes/README.md"
//   );
//   assertHeaders(t, res, "/size-12 B-44cc11.svg");
// });
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md?label=taille"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md?color=blue"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md?color=bada55"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md?style=flat"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?compression=lzma"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?max=100"
//   );
//   assertHeaders(t, res, "/size-14 B-44cc11.svg");
// });
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?max=100&softmax=100"
//   );
//   assertHeaders(t, res, "/size-14 B-44cc11.svg");
// });
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?max=100&softmax=13"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?max=100&color=orange"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?max=13&color=orange"
//   );
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg?softmax=13"
//   );
//   assertHeaders(t, res, "/size-14 B-44cc11.svg");
// });
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.json"
//   );
//   assertBody(t, res, {
//     prettySize: "14 B",
//     originalSize: 14,
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.json?compression=gzip"
//   );
//   assertBody(t, res, {
//     prettySize: "34 B",
//     originalSize: 14,
...
//   const res = await request(
//     t,
//     "/https://unpkg.com/constate.json?style=flat-square"
//   );
//   assertBody(t, res, {
//     prettySize: "573 B",
//     originalSize: 573,
...
//   const res = await request(
//     t,
//     "/baxterthehacker/public-repo/master/README.md.svg",
//     {
//       "user-agent":
...
//   const res = await request(
//     t,
//     "/https://unpkg.com/vxe-table/lib/list/src/list.min.js"
//   );
//   assertHeaders(t, res, "/size-unavailable-lightgrey.svg");
// });
